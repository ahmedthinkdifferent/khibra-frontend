...
const studentEducation = () => {
  ...
  useEffect(() => {
    ...
    const list = student.cv?.educations;
    if(list){
      setEducations(list); 
    }
  }, []);
        ...
        <div className="cv-section justify-content-start align-items-center bg-babyblue d-flex flex-column ">
          <div className="ml-4">
            <div className="pl-4 d-flex flex-column">
              ...
              <p>
                Academic background is key to unlocking potential interviews.
                Don't worry, you're almost done building your resume!
              </p>

              <ul className="mt-4">
                {educations?.map((ed) => {
                  return (
                    <li className="item m-2 p-2 d-flex justify-content-start align-items-start flex-column">
                      <h4>{ed.degree}</h4>
                      <p className="black">{ed.school}</p>
                      <p className="gray">
              ...
              {showForm && (
                <form className="signin-form" onSubmit={formik.handleSubmit}>
                  ...
                  {serverErrorMessage && (
                    <div className="form-row mt-2 justify-content-center align-items-center">
              ...
              <Form className="form signin-form d-flex flex-column justify-content-between mt-4">
                <div className="d-flex flex-row justify-content-between mt-4">
                  ...
                  <div>
                    ...
                    <input
                      disabled={requesting}
                      onClick={(e) => router.push("/student-experience")}
                      type="button"
                      className="kh-btn kh-btn-small"
                      value="Next"
                    />
